...
geospatial.thrift.FeatureState = {
'CLEAN' : 1,
'DIRTY' : 2
};
geospatial.thrift.Point = function(args) {
  this.x = null;
  this.y = null;
  if (args) {
    if (args.x !== undefined) {
...
geospatial.thrift.Rectangle = function(args) {
  this.top_lt = null;
  this.btm_rt = null;
  if (args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        this.top_lt = new geospatial.thrift.Point();
      ...
      case 2:
      if (ftype == Thrift.Type.STRUCT) {
        this.btm_rt = new geospatial.thrift.Point();
...
geospatial.thrift.Feature = function(args) {
  this.grid = null;
  this.id = null;
  this.point = null;
  this.state = null;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRING) {
        this.grid = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
